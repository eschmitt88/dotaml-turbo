...
def main() -> int:
    ...
    target = float(anchors.get("proposal_target_val_auc", 0.6462))
    ...
    metrics = {
        ...
        "delta_vs_transformer_plus_features_740": tr.best_val_auc - parent_anchor,
