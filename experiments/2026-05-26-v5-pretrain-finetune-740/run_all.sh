#!/usr/bin/env bash
# Three-phase run for v5-pretrain-finetune-740.
#
...
#   nohup bash experiments/2026-05-26-v5-pretrain-finetune-740/run_all.sh \
#     > experiments/2026-05-26-v5-pretrain-finetune-740/full_run.log 2>&1 &

set -u
cd "$(dirname "$0")/../.."  # project root

PY=".venv/bin/python -u"
EXP="experiments/2026-05-26-v5-pretrain-finetune-740"
MAX_RETRIES=3

echo "===== v5-pretrain-finetune-740 run_all START $(date -Iseconds) ====="
...
echo "===== v5-pretrain-finetune-740 run_all DONE rc=0 $(date -Iseconds) ====="
exit 0
